...
import prefect_firestore

COLLECTION_SLUG = "prefect_firestore"
...
for _, module_name, ispkg in iter_modules(prefect_firestore.__path__):
...
with mkdocs_gen_files.open(examples_catalog_path, "w") as generated_file:
    generated_file.write(
        dedent(
            ...
            Below is a list of examples for `prefect-firestore`.
            """
        )
    )
